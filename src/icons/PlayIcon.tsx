...
export function PlayIcon(props: PlayIconProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={props.width || "50px"} height={props.height || "50px"} viewBox="0 0 30.051 30.051" fill={props.fill || "#fff"} className={`${props.className}`}>
            <g>
